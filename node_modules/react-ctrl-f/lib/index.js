...
var SearchProvider = (props) => {
  ...
  const onPrev = (0, import_react.useCallback)((fixedHeaderHeight) => {
    var _a2, _b2, _c;
    if (activeCount > 0) {
  ...
  const onNext = (0, import_react.useCallback)((fixedHeaderHeight) => {
    var _a2, _b2, _c;
    if (activeCount > 0) {
  ...
  const onUpdateMatchList = (0, import_react.useMemo)((cacheList = []) => (matchList = []) => {
...
var MatchText = (data) => {
  ...
  let { searchValue, activeId, ignorecase } = (0, import_react2.useContext)(SearchContext);
  ...
  const matchData = (0, import_react2.useMemo)(() => getMatchText(searchValue, textStr, ignorecase), [searchValue]);
